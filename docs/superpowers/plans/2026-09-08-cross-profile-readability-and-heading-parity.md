...
- [x] **Step 1: Write failing model and callback tests**
...
- [x] **Step 3: Implement bounded geometry calculation**
...
- [x] **Step 5: Commit the geometry evidence slice**
...
- [x] **Step 1: Write failing XML evidence tests**
...
- [x] **Step 1: Replace the old negative test with explicit positive and safety cases**
...
- [x] **Step 3: Centralize leaf-body eligibility and abbreviation protection**
...
- [x] **Step 4: Verify semantic and rendering behavior**
...
- [x] **Step 1: Write the positive topology/evidence test**
...
- [x] **Step 2: Write fail-closed negative tests**
...
- [x] **Step 4: Implement the shared detector and immutable hint**
...
- [x] **Step 1: Add RED tests for the one-paragraph source layout**
...
- [x] **Step 3: Extend the current structural detector**
...
- [x] **Step 1: Write profile repository contract tests**
...
- [x] **Step 2: Write heading-signature RED tests**
...
- [x] **Step 3: Define language intervals without text guessing**
...
- [x] **Step 4: Implement repository injection without breaking compatibility**
...
- [x] **Step 1: Write RED hard-gate tests**
...
- [x] **Step 2: Add report and XML audit tests**
...
- [x] **Step 3: Implement gates and diagnostics**
...
- [x] **Step 1: Correct/add required sample discovery**
...
- [x] **Step 2: Add real-PDF assertions before regeneration**
...
- [x] **Step 3: Run representative integration tests**
...
- [x] **Step 4: Regenerate the five output bundles**
...
- [x] **Step 5: Inspect the human-review Markdown and machine evidence**
...
Also compare XML and Markdown text normalization, ensure all five reports have the intended status, and confirm coordinate evidence appears only in XML/report?봭ot human Markdown.

- [x] **Step 6: Update docs and commit the regression slice**
...
- [x] **Step 1: Run the complete POC suite**
...
- [x] **Step 2: Run repository compilation target**
...
- [x] **Step 3: Run cleanliness and accidental-hardcoding checks**
...
- [x] **Step 5: Address findings with tests, then rerun Steps 1??**

Any behavioral fix starts with a reproducing test. Do not declare completion from a partial suite or stale output bundle.

- [x] **Step 6: Final verification commit if review changes were needed**
