...
export const contract = {
  cliName: 'build_combined_review_excel.mjs', schemaVersion: 'combined-review-excel-view/2',
  ...
  sheets: [
    ...
    { name: 'Item Results', headers: ['고정 항목 키', '기준 문구', '현재 원문', '검토 판정',
      '설명', 'PDF 페이지', '조건 안내 원문 (후보)', '검토 메모'] },
